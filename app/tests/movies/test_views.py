...
# def test_get_single_movie(client):
    # movie = Movie.objects.create(title="xxx", genre="comedy", year="2020")

@pytest.mark.django_db
def test_get_single_movie(client, add_movie):
    movie = add_movie(title="xxx", genre="comedy", year="2020")
...
def test_get_all_movies(client, add_movie):
    print("[my debug] call: test_get_all_movies() -> movie_one")
    movie_one = add_movie(title="xxx", genre="comedy", year="2020")
    print("[my debug] call: test_get_all_movies() -> movie_two")
